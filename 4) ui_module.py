...
class Ui_MainWindow(object):
    ...
    def TOP_LIST_EDIT(self):
        ...
        text, okPressed = QtWidgets.QInputDialog.getText(self.AddTopButton, "EDIT", "Please Edit This Top:",
                                                         QtWidgets.QLineEdit.Normal, selected_items[0].text())
    ...
    def BOTTOM_LIST_EDIT(self):
        ...
        text, okPressed = QtWidgets.QInputDialog.getText(self.AddBottomButton, "EDIT", "Please Edit This Bottom:",
                                                         QtWidgets.QLineEdit.Normal, selected_items[0].text())
        for i in selected_items:
    ...
    def SHOE_LIST_EDIT(self):
        ...
        text, okPressed = QtWidgets.QInputDialog.getText(self.AddShoeButton, "EDIT", "Please Edit This Shoes:",
                                                         QtWidgets.QLineEdit.Normal, selected_items[0].text())
        for i in selected_items:
