...
sub_model = tf.keras.models.load_model('sub_model')
top_model = tf.keras.models.load_model('top_model')
bottom_model = tf.keras.models.load_model('bottom_model')
foot_model = tf.keras.models.load_model('foot_model')
